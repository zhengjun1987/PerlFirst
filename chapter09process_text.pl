...
#    }
#                doc: 吾家洗砚池头树，个个花开淡墨痕。
#                doc: 不要人夸好颜色，只流清气满乾坤。(版本一)
#                doc:
#                doc: 我家洗砚池边树，朵朵花开淡墨痕。
#                doc: 不要人夸颜色好，只留清气满乾坤。(版本二)


#    doc: Program name: granite
#    doc: Author:Gilbert Bates
#    doc: Company:RockSoft
#    doc: Department:R&D
#    doc: Phone:+1 503 555-0095
#    doc: Date:Tues March 9,2004
#    doc: Version:2.1
#    doc: Size:21k
#    doc: Status:Final Beta
...
#    say "FINISHED!";
#
#            192:PerlFirst zhengjun$ perl chapter09process_text.pl fred03.dat
